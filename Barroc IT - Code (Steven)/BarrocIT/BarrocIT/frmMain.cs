...
namespace BarrocIT
{
    public partial class frmMain : Form
    {
        ...
        private void btnCustomersRemove_Click(object sender, EventArgs e)
        {
                ...
                //SQLCommand = new SqlCommand("DELETE FROM tbl_customers AS c INNER JOIN tbl_appointments AS a WHERE c.CustomerID = @CustomerID AND a.CustomerID = @CustomerID", SQLHandler.getConnection());
                   
                SQLCommand = new SqlCommand("DELETE FROM tbl_customers WHERE CustomerID = @CustomerID", SQLHandler.getConnection());
                SQLCommand = new SqlCommand("DELETE FROM tbl_appointments WHERE CustomerID = @CustomerID", SQLHandler.getConnection());
